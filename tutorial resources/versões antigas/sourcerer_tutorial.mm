<map version="freeplane 1.2.0" NAME="Confian&#xe7;a" DATE="1363860308192" FILE="Confian&#xe7;a.mm" MAPID="dqGGxzLSQR+/8XdD21tyYg==" BGCOLOR="#F2F3F7">
<!--To view this file, download free mind mapping software Freeplane from http://freeplane.sourceforge.net -->
<node TEXT="Sourcerer Tutorial" ID="ID_1723255651" CREATED="1365039080788" MODIFIED="1371652487603" COLOR="#000034" VGAP="9" LINK="http://sourcerer.ics.uci.edu/tutorial.html" TSGSTYLE="NodeMasterGraphic">
...
<stylenode LOCALIZED_TEXT="default" MAX_WIDTH="500" COLOR="#000000" STYLE="bubble">
...
<node TEXT="Step 1: Download Sourcerer" POSITION="right" ID="ID_679518816" CREATED="1364649478929" MODIFIED="1364649482196">
<edge COLOR="#0000ff"/>
...
<node TEXT="Step 2: Set up a Repository" POSITION="right" ID="ID_749679286" CREATED="1364653075629" MODIFIED="1364653076962">
<edge COLOR="#ff00ff"/>
...
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\infrastructure\tools\java\extractor\test-repo\0\2\content\src\test\TestCharset.java" ID="ID_58875169" CREATED="1364654926926" MODIFIED="1364654930345">
...
<node TEXT="This creates a test repository" ID="ID_434702882" CREATED="1364653300854" MODIFIED="1364653302153">
...
<node TEXT="This collects all of the jar files in the repository into the jars directory" ID="ID_472604647" CREATED="1364655208057" MODIFIED="1364655248189">
...
<node TEXT="2.D) Create your own repository" ID="ID_361180221" CREATED="1364653152668" MODIFIED="1364653153609">
<node TEXT="2.D.1) Create [ROOT] directory" ID="ID_377789392" CREATED="1364653162284" MODIFIED="1364653163340">
...
<node TEXT="Step 3: Compile the repository tools" POSITION="right" ID="ID_837944869" CREATED="1364653545571" MODIFIED="1364653546704">
<edge COLOR="#00ffff"/>
...
<node TEXT="This will create repo-tools.jar in the dist subdirectory" ID="ID_456902579" CREATED="1364653661231" MODIFIED="1364653662366">
...
<node TEXT="Step 4: Finish setting up the repository" POSITION="right" ID="ID_1947162416" CREATED="1364654012546" MODIFIED="1400763371125">
<edge COLOR="#ffff00"/>
<font BOLD="true"/>
<node TEXT="Eclipse) Set up properties file" ID="ID_1962492344" CREATED="1364654125345" MODIFIED="1364654126494">
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\bin\launch\tutorial\tutorial-repo.properties" ID="ID_288570674" CREATED="1364654180775" MODIFIED="1364654184539" LINK="file:/C:/dev/Workspace/rcp_juno-sourcerer/Sourcerer/bin/launch/tutorial/tutorial-repo.properties">
<node TEXT="Setar:" ID="ID_1794922509" CREATED="1364654413079" MODIFIED="1364654416937">
...
<node TEXT="4.1) Aggregate jar files" ID="ID_689955283" CREATED="1364654131438" MODIFIED="1365089243551" VSHIFT="13">
...
<node TEXT="This collects all of the jar files in the repository into the jars directory" ID="ID_1543995494" CREATED="1364654468452" MODIFIED="1364654470086">
...
<node TEXT="launch\tutorial\Step 4 - Aggregate Jar Files.launch" ID="ID_905257649" CREATED="1364817449543" MODIFIED="1364817451098">
<node TEXT="Trocar o par&#xe2;metro:" ID="ID_1143866509" CREATED="1364817454511" MODIFIED="1364817480856">
...
<node TEXT="Step 5: Set up the Extractor" POSITION="right" ID="ID_1568421023" CREATED="1364817724325" MODIFIED="1371652453483">
<edge COLOR="#00ff00"/>
...
<node TEXT="This ant task will repackage the plugin to contain the necessary dependencies, and will place it in the dist directory" ID="ID_1384335417" CREATED="1364818017083" MODIFIED="1364818020013">
...
<node TEXT="Place the Extractor_1.0.0.jar file generated by the ant task in the [eclipse]/plugins directory" ID="ID_108573549" CREATED="1364818155673" MODIFIED="1364818157176">
...
<node TEXT="Step 6: Run the Extractor" POSITION="right" ID="ID_1732769585" CREATED="1364818485333" MODIFIED="1371652453492">
<edge COLOR="#ff00ff"/>
<node TEXT="Eclipse) Set up properties file" ID="ID_452127423" CREATED="1364654125345" MODIFIED="1364654126494">
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\bin\launch\tutorial\tutorial-extraction.properties" ID="ID_1832078541" CREATED="1364654180775" MODIFIED="1364818801693" LINK="file:/C:/dev/Workspace/rcp_juno-sourcerer/Sourcerer/bin/launch/tutorial/tutorial-extraction.properties">
<node TEXT="Setar:" ID="ID_1383039991" CREATED="1364654413079" MODIFIED="1364654416937">
...
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\bin\launch\tutorial\Step 6 - Add Java Libraries to Repo.launch" ID="ID_568370458" CREATED="1364821027431" MODIFIED="1364821027431">
<node TEXT="Alterar key=&quot;location&quot; para:" ID="ID_180825515" CREATED="1364821042212" MODIFIED="1364821058000">
...
<node TEXT="launch\tutorial\Step 6 - Extract Libraries.launch" ID="ID_1869736424" CREATED="1364820924128" MODIFIED="1364820925440">
...
<node TEXT="The results of the extraction can be seen in [output-repo]/jars/libs/" ID="ID_601615811" CREATED="1364822488715" MODIFIED="1364822500067">
...
<node TEXT="launch\tutorial\Step 6 - Extract Jars.launch" ID="ID_1902443223" CREATED="1364822381187" MODIFIED="1364822382570">
<node TEXT="Trocar o par&#xe2;metro:" ID="ID_777887982" CREATED="1364817454511" MODIFIED="1364817480856">
...
<node TEXT="The results of this extraction can be found in [output-repo]/jars/project/" ID="ID_939061344" CREATED="1364822963418" MODIFIED="1364823147933">
...
<node TEXT="launch\tutorial\Step 6 - Extract Projects.launch" ID="ID_175953116" CREATED="1364823279539" MODIFIED="1364823280796">
<node TEXT="3 projects extracted in 7.73 seconds." ID="ID_549110194" CREATED="1364823344661" MODIFIED="1364823346365"/>
</node>
<node TEXT="The results of this extraction can be found in [output-repo]/0" ID="ID_751688844" CREATED="1364823311808" MODIFIED="1364823523671">
...
<node TEXT="Step 7: Set up the database" POSITION="right" ID="ID_1783194117" CREATED="1364823587064" MODIFIED="1371652453498">
<edge COLOR="#00ffff"/>
...
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\bin\launch\tutorial\tutorial-db.properties" ID="ID_194877488" CREATED="1364654180775" MODIFIED="1364823769698" LINK="file:/C:/dev/Workspace/rcp_juno-sourcerer/Sourcerer/bin/launch/tutorial/tutorial-db.properties">
...
<node TEXT="Step 8: Set up the database tools" POSITION="right" ID="ID_1501252300" CREATED="1364824818649" MODIFIED="1371652453503">
<icon BUILTIN="closed"/>
<edge COLOR="#ffff00"/>
...
<node TEXT="Step 9: Set up the database tools" POSITION="right" ID="ID_687381512" CREATED="1364824973836" MODIFIED="1371652453509">
<edge COLOR="#7c0000"/>
<node TEXT="Initialize DB" ID="ID_362491003" CREATED="1364824986271" MODIFIED="1364824987446">
<node TEXT="launch/tutorial/Step 9 - Initialize DB.launch" ID="ID_1190285146" CREATED="1365111457606" MODIFIED="1365111462493">
...
<node TEXT="\launch\tutorial\Step 9 - Import Libraries.launch" ID="ID_703661144" CREATED="1364825114237" MODIFIED="1364825115332">
...
<node TEXT="launch\tutorial\Step 9 - Import Jars.launch" ID="ID_513425988" CREATED="1364825191467" MODIFIED="1364825192632">
...
<node TEXT="launch\tutorial\Step 9 - Import Projects.launch" ID="ID_423652039" CREATED="1364825217430" MODIFIED="1364825218366">
<node TEXT="Finished importing projects in 12.25 seconds." ID="ID_912746256" CREATED="1364825818970" MODIFIED="1364825819989"/>
</node>
</node>
</node>
<node TEXT="Step 10: Explore the database" POSITION="right" ID="ID_1606639312" CREATED="1364825905065" MODIFIED="1371652453514">
<edge COLOR="#00007c"/>
...
<node TEXT="Step 11: Set up Solr" POSITION="right" ID="ID_119824400" CREATED="1364826428465" MODIFIED="1364829627379">
...
<node TEXT="C:\dev\Workspace\rcp_juno-sourcerer\Sourcerer\infrastructure\services\index-server\conf\solrconfig.xml" ID="ID_556531710" CREATED="1364828358252" MODIFIED="1364828361741" LINK="file:/C:/dev/Workspace/rcp_juno-sourcerer/Sourcerer/infrastructure/services/index-server/conf/solrconfig.xml">
...
<node TEXT="Step 13: Build CodeGenie Index" POSITION="right" ID="ID_70373463" CREATED="1364825952858" MODIFIED="1371652453529">
<icon BUILTIN="very_positive"/>
<edge COLOR="#007c00"/>
